...
;       cdf_varput,cdfid,'mag_model_mgse',transpose(mag_model.y)
       cdf_varput,cdfid,'bfield_model_mgse_t89',transpose(mag_model.y)
;       cdf_varput,cdfid,'mag_minus_model_mgse',transpose(mag_diff.y)
       cdf_varput,cdfid,'bfield_minus_model_mgse_t89',transpose(mag_diff.y)
;       cdf_varput,cdfid,'magnitude_minus_modelmagnitude',mag_diff_magnitude
       cdf_varput,cdfid,'bfield_magnitude_minus_modelmagnitude_t89',mag_diff_magnitude
