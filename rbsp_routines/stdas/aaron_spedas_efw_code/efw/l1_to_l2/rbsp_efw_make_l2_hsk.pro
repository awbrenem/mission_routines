...
;   $LastChangedDate: 2014-12-10 10:02:17 -0600 (Wed, 10 Dec 2014) $
...
;		zero otherwise.
  ...
  tinterpol_mxn,'auto_bias',times,/spline
...
;--------------------------------------------------
  ...
  tinterpol_mxn,rbspx+'_efw_hsk_beb_analog_IEFI_IBIAS?',times,/spline
  ...
  tinterpol_mxn,rbspx+'_efw_hsk_beb_analog_IEFI_USHER?',times,/spline

  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_USHER1_interp',data=vu1
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_USHER2_interp',data=vu2
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_USHER3_interp',data=vu3
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_USHER4_interp',data=vu4
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_USHER5_interp',data=vu5
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_USHER6_interp',data=vu6

  vusher = [[vu1.y],[vu2.y],[vu3.y],[vu4.y],[vu5.y],[vu6.y]]


  tinterpol_mxn,rbspx+'_efw_hsk_beb_analog_IEFI_GUARD?',times,/spline

  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_GUARD1_interp',data=vg1
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_GUARD2_interp',data=vg2
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_GUARD3_interp',data=vg3
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_GUARD4_interp',data=vg4
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_GUARD5_interp',data=vg5
  get_data,rbspx+'_efw_hsk_beb_analog_IEFI_GUARD6_interp',data=vg6

  vguard = [[vg1.y],[vg2.y],[vg3.y],[vg4.y],[vg5.y],[vg6.y]]
...
;get_data,rbspx+'_efw_hsk_idpu_analog_IMON_BEB',data=dat
  ...
  tinterpol_mxn,rbspx+'_'+'efw_hsk_idpu_eng_SC_EFW_SSR',times,/spline
  tinterpol_mxn,rbspx+'_'+'efw_hsk_idpu_fast_B1_EVALMAX',times,/spline
  tinterpol_mxn,rbspx+'_'+'efw_hsk_idpu_fast_B1_PLAYREQ',times,/spline
  tinterpol_mxn,rbspx+'_'+'efw_hsk_idpu_fast_B1_RECBBI',times,/spline
  tinterpol_mxn,rbspx+'_'+'efw_hsk_idpu_fast_B1_RECECI',times,/spline
  tinterpol_mxn,rbspx+'_'+'efw_hsk_idpu_fast_B1_THRESH',times,/spline
  tinterpol_mxn,rbspx+'_'+'efw_hsk_idpu_fast_B2RECSTATE',times,/spline
  tinterpol_mxn,rbspx+'_'+'efw_hsk_idpu_fast_B2_THRESH',times,/spline
  tinterpol_mxn,rbspx+'_'+'efw_hsk_idpu_fast_B2_EVALMAX',times,/spline
  tinterpol_mxn,rbspx+'_efw_hsk_idpu_eng_IO_ECCSING',times,/spline
  tinterpol_mxn,rbspx+'_efw_hsk_idpu_eng_IO_ECCMULT',times,/spline
  tinterpol_mxn,rbspx+'_efw_hsk_idpu_eng_RSTCTR',times,/spline
  tinterpol_mxn,rbspx+'_efw_hsk_idpu_fast_RSTFLAG',times,/spline
  ...
  cdf_varput,cdfid,'usher_voltage',transpose(vusher)
  cdf_varput,cdfid,'guard_voltage',transpose(vguard)
