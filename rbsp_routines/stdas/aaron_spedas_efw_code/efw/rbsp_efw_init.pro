...
;$LastChangedDate: 2014-02-06 17:28:08 -0600 (Thu, 06 Feb 2014) $
...
;Skip this routine if it's already been loaded.
if tag_exist(extra,'no_rbsp_efw_init') then if extra.no_rbsp_efw_init then return
