...
; VERSION:
; Code has been tested against known good data and works fine.
;-
...
;  if ~keyword_set(rerun) then rbsp_efw_position_velocity_crib,/no_spice_load,/noplot
  ...
  ;   tinterpol_mxn,rbe+a1+a2+'_to_'+am1+am2,times,newname=rbe+a1+a2+'_to_'+am1+am2,/spline
  ;   tinterpol_mxn,rbe+a3+a4+'_to_'+am3+am4,times,newname=rbe+a3+a4+'_to_'+am3+am4,/spline
  ;
