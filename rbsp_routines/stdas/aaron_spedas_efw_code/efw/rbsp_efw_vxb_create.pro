...
pro rbsp_efw_vxb_create,velname,magname,timesinterp,title=titletmp
    ...
    vxb = [[vxB_x],[vxB_y],[vxB_z]]



    store_data,'vxb',data={x:timesint,y:vxb}
	if ~keyword_set(titletmp) then options,'vxb','ytitle','(v x B)!C' else $
		options,'vxb','ytitle',titletmp
