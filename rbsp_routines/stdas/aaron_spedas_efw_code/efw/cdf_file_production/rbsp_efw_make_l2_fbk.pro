...
pro rbsp_efw_make_l2_fbk,sc,date,$
  ...
  if ~keyword_set(folder) then folder =homedir+'Desktop/code/Aaron/RBSP/TDAS_trunk_svn/idl/general/missions/rbsp/efw/cdf_file_production/'
  ...
  if keyword_set(testing) then begin
     ...
     source_file=homedir+'Desktop/code/Aaron/RBSP/TDAS_trunk_svn/idl/general/missions/rbsp/efw/cdf_file_production/' + skeleton
  endif
