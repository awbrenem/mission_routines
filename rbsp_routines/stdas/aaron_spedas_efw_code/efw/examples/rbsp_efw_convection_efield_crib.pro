...
tinterpol_mxn,rbx+'_spinaxis_direction_gse',evar,$
  newname=rbx+'_spinaxis_direction_gse',/spline
...
newname=rbx+'_emfisis_l3_1sec_gse_Mag',/spline
...
tinterpol_mxn,rbx+'_state_pos_gse',etimes,newname=rbx+'_state_pos_gse',/spline
...
tinterpol_mxn,rbx+'_state_vel_mgse',etimes,newname=rbx+'_state_vel_mgse',/spline
