...
;   $LastChangedDate: 2020-09-11 15:35:30 -0500 (Fri, 11 Sep 2020) $
...
;    type='calibrated',datatype=['vb'+bt]
    ...
    rbsp_load_efw_waveform,probe=probe,type='calibrated',datatype=['mscb'+bt],coord='uvw'
    rbsp_load_efw_waveform,probe=probe,type='calibrated',datatype=['eb'+bt],coord='uvw'
    ;load Vburst if there is no Eburst
    if ~tdexists(rbspx+'_efw_eb'+bt,tr[0],tr[1]) then rbsp_load_efw_waveform,probe=probe,$
    type='calibrated',datatype=['vb'+bt],coord='uvw'
