...
;	channnels on EFW. Also includes notes on how to apply the calibration. Values come from 
;	the CIT (comprehensive integration testing) done b/t EMFISIS and EFW pre-launch.
;
; CATEGORIES:
;
; CALLING SEQUENCE:
...
; $LastChangedDate: 2020-04-29 13:19:22 -0500 (Wed, 29 Apr 2020) $
...
;Peak-to-peak counts vs freq (freq_cit) for SCM channel with bandwidth limiter and attenuator ON. 
;i.e. Vin was applied and the frequency response of the signal EMFISIS sends to EFW was measured. 
...
plot,freq_cit,NscmU_a,xrange=[1,20000],/xlog,/xstyle
...
Gain_e12DC_a = 1/(Ne12DC_a/Ne12DC_a[0])
Gain_e34DC_a = 1/(Ne34DC_a/Ne34DC_a[0])
Gain_e56DC_a = 1/(Ne56DC_a/Ne56DC_a[0])
Gain_e12DC_b = 1/(Ne12DC_b/Ne12DC_b[0])
Gain_e34DC_b = 1/(Ne34DC_b/Ne34DC_b[0])
Gain_e56DC_b = 1/(Ne56DC_b/Ne56DC_b[0])
...
Gscm = 2.  ;Gain of the SCMu,v,w channels (see Malaspina's DFB doc)
adc = (2.5/32768.)  ;ADC converter operates on +/-2.5 volts and has a resolution of 2^15
