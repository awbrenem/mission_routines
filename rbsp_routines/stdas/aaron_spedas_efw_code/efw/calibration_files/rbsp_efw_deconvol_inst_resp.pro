...
;
; PURPOSE:
;   De-convolve instrument responses for RBSP EFW burst data (Eb1,Eb2,MSCb1,MSCb2), including search-coil
;   data that are channeled into EFW. It will return a tplot data structure. 
;
;   Code defines the frequency response of EFW (boom response, analog filtering response, and ADC response)
;   in the frequency domain. It then FFTs this to the time domain and uses block convolution to 
;   apply the calibration to these data products. 
;
; CATEGORIES:
;
; CALLING SEQUENCE:
...
; $LastChangedDate: 2020-04-29 13:19:10 -0500 (Wed, 29 Apr 2020) $
...
; Transfer kernel into time domain: i.e. take inverse FFT and center
