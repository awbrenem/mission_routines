;Read in the burst 2 list and create an IDL save file with the
;results.

;Burst 2 list for each sc comes from create_rbsp_burst2_times_list.pro
;To get data from this list use rbsp_get_burst2_times_list.pro

pro create_burst2_times_idl_save_file,sc

  path = '/Users/aaronbreneman/Desktop/code/Aaron/RBSP/TDAS_trunk_svn/general/missions/rbsp/efw/calibration_files/'
  fn = 'burst2_times_RBSP'+sc+'.txt'
...
;  for i=0,50 do print,vals.t0[i],vals.t1[i],vals.duration[i],vals.samplerate[i]
  ...
  save,d0,d1,duration,filename=path+'burst2_times_RBSP'+sc+'.sav'
