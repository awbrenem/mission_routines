...
;---Mild and extreme charging flags.
    ...
    lshell_var = prefix+'state_lshell_interp'
    copy_data, prefix+'state_lshell', lshell_var
...
;---Auto bias.
    ...
    rbsp_load_autobias_cdf_file, probe
...
;        path = join_path([root_dir,rbspx','flags',str_year])
