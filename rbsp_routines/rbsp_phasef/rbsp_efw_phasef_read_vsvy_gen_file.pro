...
pro rbsp_efw_phasef_read_vsvy_gen_file, time, probe=probe, filename=file
...
;---Implement the time correction.
    rbsp_efw_phasef_apply_l1_time_tag_correction, l1_efw_var, probe=probe
