...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_2/general/tplot/mplot.pro $
;
;-
pro mplot,xt,yt,dy,      $
   OVERPLOT = overplot,$
...
;  if bins(n) ne 0 then begin
    ...
    if n_elements(ind) eq 1 then begin
        ;str_element, oplotstuff, 'color', sgcolor('black'), /add_replace
        c = sgcolor('black')
    endif
