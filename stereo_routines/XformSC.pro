pro XformSC,sc,freq,dens,invMatrix
; print,'new'
;
;this routine calculates the "inverse" matrix, which transforms antenna 
;  voltages to electric fields, as ESCSY = invmatrix##VZYX, where VZYX are
...
antL = fltarr(3)
Fmatrix =  fltarr(3,3) 
;print,’calling antenna_length from XformSC ‘,sc,freq,dens
...
;      and 0 = R, 1 = T, and 2 = N for spacecraft directions, assuming
