...
For Endurance, Rob wanted VLF42D and VLF14D (generated by the circuitry) to be called VLF24D and VLF41D. So, in this code
I add a "polarity" of -1 to correct for this (Steve didn't do this). From Paulo's email on Apr 2, 2024, this extra flip 
ONLY applies to the VLF24D and VLF41D channels (not the skins or the differentials). 
...
#        elif self.chn == "mag": fn = "placeholder.txt"
    ...
    def _end_channelspecs(self):
        ...
        #Note that the above polarity is ONLY relevant for the VLF24D and VLF41D channels. This is because the 
        #electronic circuits generated VLF42D and VLF14D. Rob wanted them flipped. The "real" polarity measurement comes
        #from whether "coeffa" is positive or negative. However, Steve already accounts for this in the mVm data he sends me. 
