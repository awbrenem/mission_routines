...
#Load in Steve's VLF sonograms. These are a bit nicer than mine. 
path = '/Users/abrenema/Desktop/Research/Rocket_missions/Endurance/data/efield_VLF/'
fn = '47001_TM1_LFDSP_VLF12D_mvm_FFT16384.sav'
sono12 = readsav(path + fn)
path = '/Users/abrenema/Desktop/Research/Rocket_missions/Endurance/data/efield_VLF/'
fn = '47001_TM1_LFDSP_VLF12D_mvm_FFT16384.sav'
sono12 = readsav(path + fn)
#'nfreq', 'afreq', 'atimesfft', 'afftpow'
fn = '47001_TM1_LFDSP_S5_VLF34D_mvm_FFT16384.sav'
sono34 = readsav(path + fn)
...
#idldat = readsav('/Users/abrenema/Desktop//tst.sav')
...
v12 = EFL('VLF12D')
wf12, tdat12 = v12.load_data_gainphase_corrected()
...
#nfft=2048
nfft=16384
fspec, tspec, powerc, fs = fftspec.fft_spectrum_piecewise(tdat, wf34, fs_thres=0.1, nfft=nfft, noverlap=8)
fspec12, tspec12, powerc12, fs = fftspec.fft_spectrum_piecewise(tdat12, wf12, fs_thres=0.1, nfft=nfft, noverlap=8)
