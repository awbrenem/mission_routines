;Read in GIRAFF waveform data (from gir_load_save_data_as_netcdf.py) and run Chaston's my_deg_pol.pro 
...
;fn = 'Giraff_381_efield_vlf_gp_calibrated.netcdf'
path = '/Users/abrenema/Desktop/Research/Rocket_missions/GIRAFF/data/efield_DC/'
;fn = 'Giraff_381_efield_DC_gp_calibrated.netcdf'
...
ylim,['Power','Degree$of$Polarization','Ellipticity','Helicity'],1000,40000,0
...
zlim,'Degree$of$Polarization2',0.6,1
ylim,['Power','Ellipticity2','Degree$of$Polarization2'],1000,6000,0
