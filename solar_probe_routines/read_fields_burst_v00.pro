;Load V00 (early access) Solar Probe fields burst CDF files from Keith
...
;---------------------------------------------------
;load up file
path = '/Users/aaronbreneman/Desktop/code/Aaron/github.umn.edu/mission_routines/solar_probe_routines/'
